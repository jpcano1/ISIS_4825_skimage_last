...
!wget "https://raw.githubusercontent.com/jpcano1/ISIS_4825_skimage_last/master/setup_colab.py" -O setup_colab.py
...
- Diríjase al siguiente [link](https://youtu.be/Kz8xeY9TN-c) desde su PC para ver el tutorial de instalación en Linux.